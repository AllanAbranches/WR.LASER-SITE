...
<center>
      <div class="form-cad-fundo">
             ...
             <div class="form-cad-pt2">
                <input class="caixas-cad" type="text" name="cpf" placeholder="CPF"><br>
                 ...
                 <div class="mov-btn-cad">
                    <input class="btn-cad" type="submit" name="btnCadastrar" value="CADASTRAR">
                 </div>
        ...
        if(isset($_POST['btnCadastrar'])){
            ...
            $sexo_cli = $_POST['select_sex'];

            $wrlazer->cadastrarCliente($nome,$sobrenome,$email, $senha,$dt_nas,$cpf,$cep ,$bairro,$rua ,$cidade,$numero_end ,$complemento,$sexx );
        }
        ?>
